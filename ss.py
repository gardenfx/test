...
class SpreadsheetAPI:
    def __init__(self):
        self.credentials = ServiceAccountCredentials.from_json_keyfile_name('creds.json', [
            'https://www.googleapis.com/auth/spreadsheets',
            'https://www.googleapis.com/auth/drive'])  # данные сервисного аккаунта
        ...
        self.spreadsheet_id = "1ZkPTOt1WYJ8Yq4seylAdfPV5jpRUbtAvmpdLPy7kqEc"  # токен таблицы
        self.sheet_title = "Лист1"  # заголовок листа
        self.sheet_id = "0"  # id листа
